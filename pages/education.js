    ...
    <Layout>
      ...
      <Content>
        ...
        <EducationPassage title="Fullstack course" date={2020} done src="/gostack.png" alt="Gostack Bootcamp">
          ...
          The bootcamp covered all the way from scratch to deploy, giving me the knowledge required to work on real life services and provide maintence.<br/>
          ...
          <br/><br/><Link href="/gostack-certificate.pdf">Certificate</Link>
        </EducationPassage>
